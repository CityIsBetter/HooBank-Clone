...
const Footer = () =>  (
    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col md-8 w-full`}>
        ...
        <div className="flex-[1.5] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10 mb-10">
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
        <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">2023 &#169; Mahesh Paul. All Rights Reserved&#174;.</p>
        <div className="flex flex-row md:mt-0 mt-6">
          {socialMedia.map((social, index)=>(
            <img 
              ...
              onClick={() => openInNewTab(social.link)}
            />
          ))}
        </div>
      </div>
